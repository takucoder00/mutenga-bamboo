                ...
                <div className="p-4 md:w-1/3">
                    <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                        <div className="flex items-center mb-3">
                            <div
                                className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-green-500 text-white shrink-0">
                        ...
                        <div className="flex-grow">
                            ...
                            <Link href="/contact" className="mt-3 text-green-500 inline-flex items-center">
                                <span>Learn More
                ...
                <div className="p-4 md:w-1/3">
                    <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                        ...
                        <div className="flex-grow">
                            ...
                            <Link href="/shop" className="mt-3 text-green-500 inline-flex items-center">
                                <span>Learn More
                                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                    strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                    <path d="M5 12h14M12 5l7 7-7 7"></path>
